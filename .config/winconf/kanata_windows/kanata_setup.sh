...
PSEOF
    ...
    local WIN_TEMP_BINARY WIN_CONFIG WIN_ACTIVE
...
PSEOF
    ...
    "${PWSH_EXE}" -NoProfile -Command "Start-Process pwsh.exe -Verb RunAs -Wait -ArgumentList '-NoProfile', '-ExecutionPolicy', 'Bypass', '-File', '${WIN_PS_SCRIPT}', '-TempBinary', '${WIN_TEMP_BINARY}', '-ConfigPath', '${WIN_CONFIG}', '-ActiveModulesPath', '${WIN_ACTIVE}', '-DestActiveModulesPath', '${WIN_DEST_ACTIVE}', '-Version', '${latest_version}'"
